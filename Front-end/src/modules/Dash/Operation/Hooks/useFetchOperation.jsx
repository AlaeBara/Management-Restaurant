...
export const useFetchOperation = (id) => {
  ...
  const fetchOperation= useCallback(
    async ({ page = 1, limit = 10, fetchAll = false } = {}) => {
      ...
      const url = `${import.meta.env.VITE_BACKEND_URL}/api/funds-operations`;
      ...
      try {
        ...
        console.error("Failed to fetch operations - page operation:", err);
        setMessage("Une erreur s'est produite lors du chargement des opérations");
      } finally {
        setIsloading(false);
      }
    },
