...
import { Clock, ChevronDown, ChevronUp, Receipt, User, Pizza, Salad, UtensilsCrossed, CircleDot, PlayCircle, Table2 } from "lucide-react"
  ...
  return (
    <Card className="relative p-4 m-4 w-80 h-fit cursor-pointer group transition-all duration-300 hover:shadow-lg border-l-[5px] border-l-red-500">
        ...
        <div className="mt-4 pt-4 border-t border-border">
            <Button
                variant='default'
                className="w-full transition-all bg-red-100 text-red-600 hover:bg-red-200"
            >
