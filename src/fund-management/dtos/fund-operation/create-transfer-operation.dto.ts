...
export class CreateTransferOperationDto {
    @ApiProperty({ description: 'The fund id of the operation', required: true, example: '123e4567-e89b-12d3-a456-426614174000' })
    @IsNotEmpty()
    @IsUUID()
    fundId: string;

    @ApiProperty({ description: 'The transfer fund id of the operation', required: true, example: '123e4567-e89b-12d3-a456-426614174000' })
    @IsNotEmpty()
    @IsUUID()
